import{j as e,l as y,kT as p,it as O,a as A,kU as x,kV as v,kW as be,r as R,kX as L,kY as N,kZ as je,k_ as Ce,k$ as we,l0 as J,bG as V,aG as K,l1 as Te,l2 as Q,l3 as $e,l4 as ke,cD as ve,l5 as De,l6 as Me,y as ee,l7 as Re,jP as te,l8 as B,en as Fe,av as Se,ad as Ae,l9 as Ie,b_ as Ee,bd as q,la as Le,a4 as ne}from"./strapi-e5zNjTAM.js";import{u as D,g as m,C as X,a as W,A as Oe,S as Ue,c as Y,F as Ne}from"./index-R52M3xYW.js";import{d as Be,e as Pe,D as Ze,f as ze,a as Ve,S as We,v as He,P as Ge,c as _e,C as qe}from"./sortable.esm-DZ5Zyfbe.js";import"./groupBy-DQCfKGcd.js";import"./_baseEach-YvhKpKE0.js";import"./sortBy-B5BB3pN3.js";import"./_baseMap-CGe0B5h4.js";import"./index-3mxK-AoA.js";import"./index-BRVyLNfZ.js";import"./_arrayIncludesWith-BNzMLSv9.js";const Xe=t=>{let{transform:n}=t;return{...n,x:0}},Ye=y(p)`
  position: absolute;
  left: -3.4rem;
  top: 0px;
...
`,re=R.forwardRef((t,n)=>{const{style:o,...s}=t;return e.jsx(lt,{tag:"li",ref:n,...t.attributes,style:o,background:"neutral0",shadow:t.isOverlay?"filterShadow":"none","aria-label":t.item.name,children:e.jsx(dt,{...s})})}),dt=R.memo(t=>{const{item:n,firstLoopComponentUid:o,isFromDynamicZone:s,addComponentToDZ:l,secondLoopComponentUid:a,type:i,isDragging:c,isOverlay:f,handleRef:b,listeners:k}=t,r=f||c,[d,u]=R.useState(!0),w=i.status==="REMOVED",{contentTypes:T,removeAttribute:F,isInDevelopmentMode:M}=D(),{onOpenModalEditField:I,onOpenModalEditCustomField:S}=W(),{formatMessage:g}=A(),[h,j]=R.useState(!1),C=n.status==="REMOVED",P=n.type==="relation"&&n.relation.includes("morph"),ce=["integer","biginteger","float","decimal"].includes(n.type)?"number":n.type,E=n.type==="relation"?O(T,n.target):null,H=O(E,"plugin"),ue="target"in n&&n.target?"relation":ce,pe=$=>{$.stopPropagation(),Y(T,n.name).length>0?j(!0):F({forTarget:i.modelType,targetUid:i.uid,attributeToRemoveName:n.name})},ge=()=>{F({forTarget:i.modelType,targetUid:i.uid,attributeToRemoveName:n.name}),j(!1)},me=()=>{j(!1)},G=()=>{if(!P&&n.configurable!==!1){const $=a||o||i.uid,Z=Qe(n.type),ye=n.type==="component"?"2":null;n.customField?S({forTarget:i.modelType,targetUid:$,attributeName:n.name,attributeType:Z,customFieldUid:n.customField}):I({forTarget:i.modelType,targetUid:$,attributeName:n.name,attributeType:Z,step:ye})}};let U;a&&o?U=2:o?U=1:U=0;const _=!w&&!C,fe=!w&&!C,he=w||C?"not-allowed":"move",xe=M&&n.configurable!==!1&&!P&&_;return e.jsxs(e.Fragment,{children:[e.jsxs(at,{$isOverlay:f,$isDragging:c,onClick:xe?G:void 0,paddingLeft:4,paddingRight:4,children:[e.jsxs(x,{alignItems:"center",overflow:"hidden",gap:2,children:[U!==0&&!f&&e.jsx(Ke,{color:s?"primary200":"neutral150"}),M&&e.jsx(N,{cursor:he,role:"Handle",ref:b,...k,variant:"ghost",withTooltip:!1,label:`${g({id:"app.utils.drag",defaultMessage:"Drag"})} ${n.name}`,disabled:w||C,children:e.jsx(je,{})}),e.jsxs(x,{gap:4,children:[e.jsxs(x,{gap:4,alignItems:"center",children:[e.jsx(Oe,{type:ue,customField:n.customField}),e.jsxs(v,{textColor:"neutral800",fontWeight:"bold",textDecoration:C?"line-through":"none",ellipsis:!0,overflow:"hidden",children:[n.name,"required"in n&&n.required&&e.jsx(v,{textColor:"danger600",children:"* "})]})]}),e.jsx(x,{children:e.jsxs(v,{textColor:"neutral600",children:[e.jsx(et,{type:n.type,customField:n.customField,repeatable:"repeatable"in n&&n.repeatable,multiple:"multiple"in n&&n.multiple}),"conditions"in n&&n.conditions&&Object.keys(n.conditions).length>0&&e.jsx(Ce,{margin:4,children:"conditional"}),n.type==="relation"&&e.jsxs(e.Fragment,{children:[" (",we(n.relation,n.targetAttribute),") ",E&&g({id:m("modelPage.attribute.with"),defaultMessage:"with"})," ",E&&e.jsx(J,{onClick:$=>$.stopPropagation(),tag:K,to:`/plugins/content-type-builder/content-types/${E.uid}`,children:V(E.info.displayName)}),H&&`(${g({id:m("from"),defaultMessage:"from"})}: ${H})`]}),n.type==="component"&&e.jsx(ut,{uid:n.component})]})})]})]}),e.jsx(p,{children:e.jsx(x,{justifyContent:"flex-end",gap:1,onClick:$=>$.stopPropagation(),children:e.jsxs(e.Fragment,{children:[e.jsx(p,{children:n.status&&e.jsx(Ue,{status:n.status})}),["component","dynamiczone"].includes(n.type)&&e.jsx(N,{onClick:$=>{$.preventDefault(),$.stopPropagation(),u(!d)},"aria-expanded":d,label:g({id:"app.utils.toggle",defaultMessage:"Toggle"}),variant:"ghost",withTooltip:!1,children:e.jsx(Te,{"aria-hidden":!0,fill:"neutral500",style:{transform:`rotate(${d?"0deg":"-90deg"})`,transition:"transform 0.5s"}})}),M&&n.configurable!==!1?e.jsxs(e.Fragment,{children:[!P&&e.jsx(N,{onClick:G,label:`${g({id:"app.utils.edit",defaultMessage:"Edit"})} ${n.name}`,variant:"ghost",disabled:!_,children:e.jsx(Q,{})}),e.jsx(N,{onClick:pe,label:`${g({id:"global.delete",defaultMessage:"Delete"})} ${n.name}`,variant:"ghost",disabled:!fe,children:e.jsx($e,{})}),e.jsx(ke.Root,{open:h,onOpenChange:j,children:e.jsx(ve,{onConfirm:ge,onCancel:me,children:e.jsx(p,{children:e.jsxs(v,{children:[g({id:m("popUpWarning.bodyMessage.delete-attribute-with-conditions"),defaultMessage:"The following fields have conditions that depend on this field: "}),e.jsx(v,{fontWeight:"bold",children:Y(T,n.name).map(({attribute:$})=>$).join(", ")}),g({id:m("popUpWarning.bodyMessage.delete-attribute-with-conditions-end"),defaultMessage:". Are you sure you want to delete it?"})]})})})})]}):e.jsx(x,{padding:2,children:e.jsx(De,{fill:"neutral500"})})]})})})]}),e.jsxs(ct,{$shouldHideNestedInfos:r,$isOpen:d,children:[n.type==="component"&&e.jsx(ie,{...n,isFromDynamicZone:s,firstLoopComponentUid:o}),n.type==="dynamiczone"&&e.jsx(rt,{...n,disabled:w||n.status==="REMOVED",addComponent:l,forTarget:i.modelType,targetUid:i.uid})]})]})}),ct=y(p)`
...
`,ut=({uid:t})=>{const{components:n}=D(),o=O(n,t);return e.jsxs(e.Fragment,{children:[" (",e.jsx(J,{onClick:s=>s.stopPropagation(),tag:K,to:`/plugins/content-type-builder/component-categories/${o.category}/${o.uid}`,children:V(o.info.displayName)}),")"]})},ae=y(p)`
  height: 2.4rem;
  width: 2.4rem;
  border-radius: 50%;
  display: flex;
...
`,bt=R.memo(({disabled:t,type:n})=>{const{formatMessage:o}=A(),s=Se(),l=ht(n),a=o({id:"content-type-builder.form.button.configure-view",defaultMessage:"Configure the view"}),i=()=>{if(t)return!1;const b=xt(n);return s(b),!1},{isLoading:c,allowedActions:f}=Ae(l);return c||!f.canConfigureView&&!f.canConfigureLayout?null:e.jsx(yt,{startIcon:e.jsx(Ie,{}),variant:"tertiary",onClick:i,disabled:t,children:a})}),jt=y(ne.Header)`
  ...
  white-space: nowrap;
`,St=()=>{const{isInDevelopmentMode:t,contentTypes:n,components:o,isLoading:s}=D(),{formatMessage:l}=A(),{trackUsage:a}=ee(),{contentTypeUid:i,componentUid:c}=Ee(),{onOpenModalAddComponentsToDZ:f,onOpenModalAddField:b,onOpenModalEditSchema:k}=W(),r=i?n[i]:c?o[c]:null;if(s)return null;if(!r){const j=Object.values(n).filter(C=>C.visible===!0&&!C.plugin).map(C=>C.uid).sort();return j.length>0?e.jsx(q,{to:`/plugins/content-type-builder/content-types/${j[0]}`}):e.jsx(q,{to:"/plugins/content-type-builder/content-types/create-content-type"})}const d="plugin"in r&&r?.plugin!==void 0,u=i?"contentType":"component",w=r?.info?.displayName??"",T=t&&!d,F=j=>{f({dynamicZoneTarget:j,targetUid:r.uid})},M=()=>{if("kind"in r){r?.kind==="collectionType"&&a("willEditNameOfContentType"),r?.kind==="singleType"&&a("willEditNameOfSingleType"),k({modalType:u,forTarget:u,targetUid:r.uid,kind:r?.kind});return}k({modalType:u,forTarget:u,targetUid:r.uid})},I=l({id:m("table.button.no-fields"),defaultMessage:"Add new field"}),S=l({id:m("button.attributes.add.another"),defaultMessage:"Add another field"}),g=r.status==="REMOVED",h=t&&e.jsxs(x,{gap:2,children:[e.jsx(bt,{type:r,disabled:r.status==="NEW"||g},"link-to-cm-settings-view"),e.jsx(B,{startIcon:e.jsx(Q,{}),variant:"tertiary",onClick:M,disabled:!T||g,children:l({id:"app.utils.edit",defaultMessage:"Edit"})}),e.jsx(B,{startIcon:e.jsx(L,{}),variant:"secondary",minWidth:"max-content",onClick:()=>{b({forTarget:u,targetUid:r.uid})},disabled:g,children:r.attributes.length===0?I:S})]});return e.jsxs(e.Fragment,{children:[e.jsx(te.contentTypeBuilder.Introduction,{children:e.jsx(p,{})}),g&&e.jsx(x,{background:"danger100",justifyContent:"center",padding:4,children:e.jsxs(x,{gap:2,children:[e.jsx(Le,{fill:"danger600",height:"2rem",width:"2rem"}),e.jsx(v,{children:l({id:m("table.warning.deleted"),defaultMessage:"This {kind} has been deleted"},{kind:r.modelType==="contentType"?"Content Type":"Component"})})]})}),e.jsx(jt,{id:"title",primaryAction:h,title:V(w)}),e.jsx(ne.Content,{children:e.jsx(p,{background:"neutral0",shadow:"filterShadow",hasRadius:!0,overflow:"auto",borderColor:"neutral150",children:e.jsx(de,{type:r,addComponentToDZ:F,isMain:!0})})})]})};export{St as default};
