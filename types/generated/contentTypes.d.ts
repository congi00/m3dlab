...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    section: Schema.Attribute.DynamicZone<
      [
        'shared.header',
        'shared.home-preventive-section',
        'shared.info-choice-section',
...
export interface ApiQuoteQuote extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    quote: Schema.Attribute.Decimal & Schema.Attribute.Required;
    service: Schema.Attribute.Enumeration<
      ['Stampa 3D', 'Incisione Laser', 'Lavorazioni CNC']
    > &
      Schema.Attribute.Required;
    stats: Schema.Attribute.Enumeration<['Pending', 'Sent']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
